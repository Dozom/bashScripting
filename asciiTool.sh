...
echo "\n"
echo "Paste your Decimal String without quotes:"
read ascii_string


echo "Your ASCII String is the following:"

for i in ${ascii_string[@]};do
	# Formatting the decimal numbers if begins with 0
	formated_number=`echo $i | sed 's/^0*//'`

	# Decimal to ASCII here
	printf "\\$(printf %o $formated_number)"
done;
